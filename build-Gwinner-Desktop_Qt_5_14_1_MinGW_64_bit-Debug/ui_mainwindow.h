...
"border:0;"));
        ...
        foodContainer = new QWidget();
        foodContainer->setObjectName(QString::fromUtf8("foodContainer"));
        foodContainer->setGeometry(QRect(0, 0, 391, 1030));
        verticalLayout = new QVBoxLayout(foodContainer);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        label_9 = new QLabel(foodContainer);
        ...
        FoodImage1 = new QPushButton(foodContainer);
        ...
        groupBox_3 = new QGroupBox(foodContainer);
...
"border:0;"));
        ...
        FoodImage2 = new QPushButton(foodContainer);
        ...
        groupBox_4 = new QGroupBox(foodContainer);
...
"background-color: rgb(48, 48, 48);"));
        ...
        FoodImage3 = new QPushButton(foodContainer);
        ...
        groupBox_5 = new QGroupBox(foodContainer);
...
"background-color: rgb(48, 48, 48);"));
        ...
        FoodImage4 = new QPushButton(foodContainer);
        ...
        groupBox_6 = new QGroupBox(foodContainer);
...
"background-color: rgb(48, 48, 48);"));
        ...
        scrollArea->setWidget(foodContainer);
...
"border:0;"));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 379, 1603));
